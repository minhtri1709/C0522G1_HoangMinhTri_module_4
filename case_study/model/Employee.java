...
public class Employee {
    ...
    public Employee(int id, String name, String dateOfBirth, String idCard,
                    int salary, String phoneNumber, String email,
    ...
    public Employee(String name, String dateOfBirth, String idCard, int salary, String phoneNumber, String email, String address, String userName) {
        this.name = name;
        this.dateOfBirth = dateOfBirth;
        this.idCard = idCard;
        this.salary = salary;
