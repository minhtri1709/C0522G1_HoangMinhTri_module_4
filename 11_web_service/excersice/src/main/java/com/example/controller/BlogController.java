...
public class BlogController {
    ...
    @RequestMapping(value = "blog/{name}/search", method = RequestMethod.GET)
    public ResponseEntity<Blog> searchByName(@PathVariable String name) {
        Blog blog = iBlogService.searchByName(name);
        if (blog == null) {
